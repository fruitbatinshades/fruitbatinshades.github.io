...
export class Boxes extends Phaser.Physics.Arcade.Group {
    ...
    addCollisions() {
        ...
        this.scene.physics.add.collider(boxes, rocks, Box.tileCollide, null, this);//stop flit on rocks
    ...
    onBoxDestruct(box) {
        ...
        if (box.lastContact !== null && (box.lastContact.constructor.name === 'InteractionZone' || box.lastContact.constructor.name === 'InteractionContainer')) {
